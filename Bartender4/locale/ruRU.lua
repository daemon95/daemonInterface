...
L["Enable the Blizzard Art Bar"] = "Включить графическую панель Blizzard"
...
L["Right"] = "Вправо"
L["Right-click Self-Cast"] = "ПКМ – примененить на себя"
...
L["Show Reputation Bar"] = "Отобразить полосу репутации"
L["Show the keyring button."] = "Отображать кнопку связки ключей."
L["Show XP Bar"] = "Показать индикатор опыта"
