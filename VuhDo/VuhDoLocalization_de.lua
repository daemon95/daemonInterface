...
VUHDO_I18N_LOAD_SKIN = "Skin laden";
VUHDO_I18N_LOAD_ARRANGEMENT = "Arrangement laden";
...
VUHDO_I18N_SMARTBUFF_ERR_5 = "VuhDo: Sie buffen zu schnell! Nochmal versuchen!";
...
VUHDO_I18N_NO_BUFFS_DEFINED = "Für Ihre Klasse sind keine Buffs definiert!";
