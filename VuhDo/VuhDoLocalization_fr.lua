...
VUHDO_I18N_LOAD_SKIN = "Load Skin";
VUHDO_I18N_LOAD_ARRANGEMENT = "Load Arrangement";
...
VUHDO_I18N_SMARTBUFF_ERR_5 = "VuhDo: You are buffing too fast. Try again!";
...
VUHDO_I18N_NO_BUFFS_DEFINED = "There are no buffs defined for your class!";

-- #+1.187
VUHDO_I18N_KEY_BIND_SMART_CAST = "Keybind \"smartcast\"";
