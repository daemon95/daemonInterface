...
VUHDO_I18N_LOAD_SKIN = "读取皮肤";
VUHDO_I18N_LOAD_ARRANGEMENT = "读取布局";
...
VUHDO_I18N_SMARTBUFF_ERR_5 = "VuhDo: BUFF过于频繁. 重试!";
...
VUHDO_I18N_NO_BUFFS_DEFINED = "您的职业不具备已定义增益!";

-- #+1.187
VUHDO_I18N_KEY_BIND_SMART_CAST = "按键绑定 \"智能施法\"";
