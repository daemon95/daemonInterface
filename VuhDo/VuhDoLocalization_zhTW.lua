...
VUHDO_I18N_LOAD_SKIN = "讀取皮膚";
VUHDO_I18N_LOAD_ARRANGEMENT = "讀取佈局";
...
VUHDO_I18N_SMARTBUFF_ERR_5 = "VuhDo: BUFF過於頻繁.重試!";
...
VUHDO_I18N_NO_BUFFS_DEFINED = "您的職業不具備已定義增益!";

-- #+1.187
VUHDO_I18N_KEY_BIND_SMART_CAST = "按鍵綁定\"智能施法\"";
