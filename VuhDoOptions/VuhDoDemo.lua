...
local function VUHDO_generateLeetName()
	return VUHDO_LEET_NAME_PREFIXES[math.random(1, #VUHDO_LEET_NAME_PREFIXES)]
		.. VUHDO_LEET_NAME_SUFFIXES[math.random(1, #VUHDO_LEET_NAME_SUFFIXES)];
end
...
local function VUHDO_getRandomHealth(aMax)
	...
	elseif (tRandom == 2) then
		return floor(random(0, aMax) / 2 + aMax / 2);
	else
