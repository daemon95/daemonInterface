...
IceOmniBar = IceCore_CreateClass(IceVBarElement)

IceOmniBar.prototype.unit = nil
IceOmniBar.prototype.alive = nil
IceOmniBar.prototype.tapped = nil

IceOmniBar.prototype.health = nil
IceOmniBar.prototype.maxHealth = nil
IceOmniBar.prototype.healthPercentage = nil
IceOmniBar.prototype.mana = nil
IceOmniBar.prototype.maxMana = nil
IceOmniBar.prototype.manaPercentage = nil
IceOmniBar.prototype.scaleHPColorInst = nil
IceOmniBar.prototype.scaleMPColorInst = nil

IceOmniBar.prototype.unitClass = nil
IceOmniBar.prototype.hasPet = nil

IceOmniBar.prototype.noFlash = nil

-- Constructor --
function IceOmniBar.prototype:init(name, unit)
	IceOmniBar.super.prototype.init(self, name)
	assert(unit, "IceOmniBar 'unit' is nil")
...
function IceOmniBar.prototype:SetUnit(unit)
	self.unit = unit
	_, self.unitClass = UnitClass(self.unit)
end

-- OVERRIDE
function IceOmniBar.prototype:GetDefaultSettings()
	local settings = IceOmniBar.super.prototype.GetDefaultSettings(self)
...
-- OVERRIDE
function IceOmniBar.prototype:GetOptions()
	local opts = IceOmniBar.super.prototype.GetOptions(self)
...
function IceOmniBar.prototype:Enable()
	IceOmniBar.super.prototype.Enable(self)
...
-- OVERRIDE
function IceOmniBar.prototype:Redraw()
	IceOmniBar.super.prototype.Redraw(self)
...
-- OVERRIDE
function IceOmniBar.prototype:CreateFrame()
	IceOmniBar.super.prototype.CreateFrame(self)

	self:CreateFlashFrame()
end

-- Creates the low amount warning frame
function IceOmniBar.prototype:CreateFlashFrame()
...
function IceOmniBar.prototype:RotateHorizontal()
	IceOmniBar.super.prototype.RotateHorizontal(self)

	self:RotateFrame(self.flashFrame)
end

function IceOmniBar.prototype:ResetRotation()
	IceOmniBar.super.prototype.ResetRotation(self)
...
-- OVERRIDE
function IceOmniBar.prototype:Update()
	IceOmniBar.super.prototype.Update(self)
...
function IceOmniBar.prototype:Alive()
...
function IceOmniBar.prototype:Dead()
	self.alive = false
	self:Update(self.unit)
end
...
-- OVERRIDE
function IceOmniBar.prototype:UpdateBar(scale, color, alpha)
	IceOmniBar.super.prototype.UpdateBar(self, scale, color, alpha)
...
function IceOmniBar.prototype:OnFlashUpdate()
	local time = GetTime()
...
function IceOmniBar.prototype:SetScaleColorEnabled(enabled)
