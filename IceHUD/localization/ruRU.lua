...
L["1 combo point: yellow, 5 combo points: red"] = "1 приём: жёлтый, 5 приёмов: красный"
L["1 lacerate: yellow, 5 lacerates: red"] = "1 растерзание: жёлтый, 5 растерзаний: красный"
L["1 maelstrom: yellow, 5 maelstroms: red"] = "1 водоворот: жёлтый, 5 водоворотов: красный"
L["1 sunder: yellow, 5 sunders: red"] = "1 раскол: жёлтый, 5 расколов: красный"
L["A custom bar has been created and can be configured through Module Settings => MyCustomBar. It is highly recommended that you change the bar name of this module so that it's easier to identify."] = "Пользовательская полоса была создана и может быть настроена через Module Settings => MyCustomBar. Настоятельно рекомендуется переименовать полосу этого модуля, чтобы было легче её узнать."
...
L["Abbreviate estimated health"] = "Сокращённо: остаток здоровья"
L["Abbreviate health"] = "Сокращённо: здоровье"
L["Adjust the horizontal position of the aura icon"] = "Настроить горизонтальное расположение иконки ауры"
L["Adjust the vertical placement of this bar"] = "Настроить вертикальное расположение этой полосы"
L["Adjust the vertical position of the aura icon"] = "Настроить вертикальное расположение иконки ауры"
L["Adjusts the size of the aura icon for this bar"] = "Настраивает размер иконки ауры для этой панели"
L["Advanced Bar Settings"] = "Продвинутые настройки полосы"
L["Aggro Indicator alpha"] = "Прозрачность индикатора угрозы"
L["Aggro indicator alpha (0 is disabled)"] = "Прозрачность индикатора угрозы (0 - выключено)"
L["Alert Party"] = "Alert Party" -- Requires localization
L["Allow click casting"] = "Разрешить применение заклинаний по клику"
L["Allow click-targeting"] = "Разрешить выбор цели по клику"
L["Allow click-targeting in combat"] = "Разрешить выбор цели по клику в бою"
L["Alpha OOC and Target"] = "Прозрачность вне боя на цели"
L["Alpha OOC and not full"] = "Прозрачность вне боя с неполным ресурсом (здоровьем)"
...
L["Always show at 100% alpha"] = "Всегда 100% непрозрачность"
...
L["Answers to questions that are frequently asked."] = "Ответы на часто задаваемые вопросы."
L["Are you sure you want to delete this module? This will remove all settings associated with it and cannot be un-done."] = "Точно необходимо удалить этот модуль? Это также удалит все настройки, связанные с этим модулем, и восстановить их больше не удастся."
L["Aura icon horizontal offset"] = "Горизонтальное смещение иконки ауры"
L["Aura icon scale"] = "Масштаб иконки ауры"
L["Aura icon vertical offset"] = "Вертикальное смещение иконки ауры"
L["Aura settings"] = "Настройки ауры"
L["Aura to track"] = "Следить за аурой"
L["Automatically size this module to the addon's 'gap' setting"] = "Автоматичски подстраивать размер этого модуля под настройки 'промежутка' аддона"
L["BG Alpha OOC and Target"] = "Прозрачность фона вне боя на цели"
L["BG Alpha OOC and not Full"] = "Прозрачность фона вне боя с неполным ресурсом (здоровьем)"
...
L["Background alpha for bars IC"] = "Прозрачность фона полос в бою"
