...
function IceTargetHealth.prototype:GetDefaultSettings()
	...
	settings["lowerText"] = "[HP:Round:HPColor:Bracket]"
	...
	settings["PartyRoleIconOffset"] = {x=158, y=20}
