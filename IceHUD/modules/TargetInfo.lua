...
function IceTargetInfo.prototype:GetDefaultSettings()
	...
	defaults["hpos"] = 0
	defaults["zoom"] = 0.00
	defaults["buffSize"] = 24
	defaults["ownBuffSize"] = 32
	defaults["buffOffset"] = {x=-10,y=80}
	defaults["buffAnchorTo"] = "TOPLEFT"
	defaults["buffGrowDirection"] = "Left"
	defaults["debuffOffset"] = {x=10, y=80}
	...
	--defaults["perRow"] = 8
	defaults["perRow"] = 12
	defaults["line1Tag"] = "[Name:ClassColor]"
