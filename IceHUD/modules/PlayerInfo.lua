...
-- Custom
	...
	settings["vpos"] = 547
	settings["perRow"] = 12
	settings["stackFontSize"] = 12
	settings["showBuffs"] = false
	settings["buffOffset"] = {x=0,y=0}
	settings["buffAnchorTo"] = "BOTTOMRIGHT"
	settings["buffGrowDirection"] = "Left"
	settings["showDebuffs"] = false
	settings["debuffOffset"] = {x= 0,y=0}
	settings["debuffAnchorTo"] = "BOTTOMLEFT"
	settings["debuffGrowDirection"] = "Right"
	settings["line1Tag"] = "[MainAssistIcon MainTankIcon Name:ClassColor (~IsMaxLevel ? ' (' (RestXP > 0 ? FractionalXP:Blue ! FractionalXP:Fuchsia) ')')]"
	settings["line3Tag"] = ""
